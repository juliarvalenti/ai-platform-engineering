...
// Ported from tiny-teams-with-tokens `frontend/components/KindBadge.tsx`.
// Visual identity for each page kind (stable / dynamic / hidden / report),
...
const SPECS: Record<PageKind, Spec> = {
  stable: {
    label: "stable",
    Icon: Anchor,
    badgeClass:
